package com.hyx.webflux.javaee.aspect;
...
import com.hyx.webflux.javaee.util.AspectUtils;
...
public class RedisReactiveCacheAspect {
     ...
     */
    @Around("execution(public * *(..)) && @annotation(com.hyx.webflux.javaee.annotation.RedisReactiveCacheAdd)")
     ...
     */
    @Around("execution(public * *(..)) && @annotation(com.hyx.webflux.javaee.annotation.RedisReactiveCacheGet)")
     ...
     */
    @Around("execution(public * *(..)) && @annotation(com.hyx.webflux.javaee.annotation.RedisReactiveCacheUpdate)")
     ...
     */
    @Around("execution(public * *(..)) && @annotation(com.hyx.webflux.javaee.annotation.RedisReactiveCacheEvict)")
